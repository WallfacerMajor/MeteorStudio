...
if defined FFMPEG_BIN (
  python -m PyInstaller --noconfirm --clean --windowed --name MeteorStudio --hidden-import meteor_learning --hidden-import video_meteor --hidden-import alignment_workspace --hidden-import ptgui_pipeline --hidden-import meteor_screening --hidden-import gui_interaction_smoke --hidden-import editable_composite_smoke --exclude-module torch --exclude-module torchvision --exclude-module transformers --exclude-module triton --exclude-module llvmlite --exclude-module numba --exclude-module onnx --exclude-module onnxruntime --exclude-module matplotlib --exclude-module timm --exclude-module tokenizers --add-data "meteor_ranker.json;." --add-data "candidate_dataset.npz;." --add-binary "%FFMPEG_BIN%;." meteor_composer.py
) else (
